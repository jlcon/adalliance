...
public interface ClOrderInfoMapper {
	 ...
	 * @mbggenerated  Thu Dec 08 10:04:22 CST 2016
	 */
	int updateByExampleSelective(@Param("record") ClOrderInfo record,
									@Param("example") ClOrderInfoExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table cl_order_info
	 * @mbggenerated  Thu Dec 08 10:04:22 CST 2016
	 */
	int updateByExample(@Param("record") ClOrderInfo record,
						@Param("example") ClOrderInfoExample example);
